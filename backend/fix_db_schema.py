...
DATABASE_URL = "postgresql://neondb_owner:***REMOVED***@ep-rapid-truth-agfga13q-pooler.c-2.eu-central-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require"
...
def fix_schema():
    ...
    with engine.connect() as connection:
        ...
        if 'reports' in tables:
            ...
            # Drop indexes first if needed, but CASCADE might handle it? 
            # Safer to just drop table CASCADE
