...
const translations: Record<SupportedLang, Record<string, string>> = {
  fr: {
    ...
    category_optional: 'Choisir une catégorie (optionnel)',
    select_cosmetic_category: 'Sélectionner la catégorie',
    categories_available: 'catégories disponibles',
    category_not_specified: 'Aucune catégorie',
  ...
  en: {
    ...
    category_optional: 'Choose a category (optional)',
    select_cosmetic_category: 'Select the category',
    categories_available: 'categories available',
    category_not_specified: 'No category',
  ...
  ar: {
    ...
    category_optional: 'اختر فئة (اختياري)',
    select_cosmetic_category: 'اختر الفئة',
    categories_available: 'فئة متاحة',
    category_not_specified: 'بدون فئة',
