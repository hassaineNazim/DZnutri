...
export default function SubmissionPage() {
  ...
  return (
    ...
    <View className="flex-1 justify-center bg-white p-6 dark:bg-[#181A20]">
     

      <TextInput
        className="bg-gray-100 p-4 rounded-xl mb-4 text-base text-gray-800 dark:bg-[#24292E] dark:text-white"
      ...
      <TextInput
        className="bg-gray-100 p-4 rounded-xl mb-8 text-base text-gray-800 dark:bg-[#24292E] dark:text-white"
      ...
      <TouchableOpacity
        ...
        disabled={loading}
        className="bg-lime-500 py-4 rounded-xl flex-row justify-center items-center dark:bg-green-500"
      >
        {loading ? (
